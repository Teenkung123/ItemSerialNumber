...
public class ConfigLoader {
    ...
    static String messageFailedToUnregister;
    static String messageItemAlreadyHaveSerial;
    static String messageCommandCanOnlySendByPlayer;

    public static void generateConfigFile() {
        System.out.println(colorize("&aChecking and Generating Config File"));
        ItemSerialNumber.getInstance().getConfig().options().copyDefaults(true);
    ...
    public static void loadConfigurations() {
        ...
        //==================================================================================
        messagePrefix = colorize(Instance.getConfig().getString("Message.Prefix", "&7[&6ISN&7] &r"));
        messageNoPermission = colorize(Instance.getConfig().getString("Message.noPermission", colorize("&cYou do not have permission to perform this command!")));
        messageSuccessRegister = colorize(Instance.getConfig().getString("Message.successRegister", colorize("&aSuccessfully Registered this Item to SerialCommand System!")));
        messageSuccessUnregister = colorize(Instance.getConfig().getString("Message.successUnregister", colorize("&cSuccessfully Unregistered this Item from SerialCommand System!")));
        ...
        messageSerialNotFound = colorize(Instance.getConfig().getString("Message.serialNotFound", colorize("&cSerial Number Not Found from this item")));
        messageFailedToUnregister = colorize(Instance.getConfig().getString("Message.failedToUnregister", colorize("&cFailed to Unregister this Item from SerialCommand System! \n&cBecause it was set to prevent unRegistration")));
        messageItemAlreadyHaveSerial = colorize(Instance.getConfig().getString("Message.itemAlreadyHaveSerial", colorize("&cThis item already have Serial Number!")));
        messageCommandCanOnlySendByPlayer = colorize(Instance.getConfig().getString("Message.commandCanOnlySendByPlayer", colorize("&cThis Command can only be sent by player!")));
    }
    ...
    public static int getBlockMessageSendEvery() {
        return blockMessageSendEvery;
    }

    public static String getBlockMessageMessage() {
        return blockMessage;
    }
    ...
    public static String getMessageSuccessRegister() {
        return messageSuccessRegister;
    }

    public static String getMessageSuccessUnregister() {
        return messageSuccessUnregister;
    }

    public static ArrayList<String> getMessageItemInfoAdmin() {
        return messageItemInfoAdmin;
    }

    public static ArrayList<String> getMessageItemInfoDefault() {
        return messageItemInfoDefault;
    }

    public static String getMessageSerialNotFound() {
        return messageSerialNotFound;
    }

    public static String getMessageFailedToUnregister() {
        return messageFailedToUnregister;
    }

    public static String getMessageItemAlreadyHaveSerial() {
        return messageItemAlreadyHaveSerial;
    }

    public static String getMessageCommandCanOnlySendByPlayer() {
        return messageCommandCanOnlySendByPlayer;
    }
